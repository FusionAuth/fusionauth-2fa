...
public class Base32 extends BaseNCodec {
   ...
   * @throws IllegalArgumentException The provided lineSeparator included some Base32 characters. That's not going to
   *                                  work!
   */
   ...
   *                <p>
   *                Output is written to {@link Context#buffer} as 8-bit octets, using {@link Context#pos} as the buffer
   *                position
   */
  @Override
