...
public final class TwoFactor {
   ...
   */
  public static String calculateVerificationCode(String encodedSecret, long instant) {
   ...
   *
   * @param rawSecret The string as a String, not encoded.
   ...
   */
  public static byte[] generateSha1HMAC(String secret, byte[] data) {
    try {
